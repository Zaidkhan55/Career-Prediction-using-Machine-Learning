...
def result():
    if request.method=='POST':
        ...
        input = np.array([int(cgpa), int(webd), int(da), int(rws), int(tp), int(ntp), int(c), int(ad), int(cs), int(s), int(db), int(ds), int(eng), int(e), int(tb), int(m), int(ml), int(con), int(lp)])
        print(input)
        print(type(input))
